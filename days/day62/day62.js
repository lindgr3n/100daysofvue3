...
var BoardCell = /** @class */ (function () {
    ...
    BoardCell.prototype.getElement = function () {
        return this.element;
    };
    return BoardCell;
}());
var GameManager = /** @class */ (function () {
    ...
    GameManager.prototype.onClick = function (evt) {
        ...
        // Check win condition
        var victory = this.winConditon.find(function (cords) {
            return cords.every(function (cord) { return _this.boardManager.getBoardById({ x: cord[0], y: cord[1] }).getClickedBy() === player; });
        });
        console.log('VICTORY', victory);
        if (victory) {
            victory.forEach((function (cord) {
                var cell = _this.boardManager.getBoardById({ x: cord[0], y: cord[1] });
